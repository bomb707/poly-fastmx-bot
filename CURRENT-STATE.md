...
After release selection, a new causal trend/noise model estimates the selected side's win probability. It requires probability at least 0.50 and nonnegative edge after ask price and modeled fee. The runtime records continuation, temporary-noise, pullback-entry, possible-reversal, confirmed-reversal, or uncertain state. Accepted decisions retain the existing residual and partial-versus-cross trees, but fee-adjusted confidence scales the residual only downward from 1.00× toward 0.50×. The signed-order range remains 5–227 shares, cross cutoff 0.485064, and planned gross ceiling 300 shares. Orders remain fixed-USDC marketable FAK BUY intents, matching the observed target encoding at the level public data supports.
...
This is not an exact target clone. Discovery holdout autonomous timing parity is 19.345% precision, 32.837% recall, and 24.347% F1; frozen partial OOS is 18.769% / 31.323% / 23.473%. The prior runtime replay lost $1,932.78 on 1,508 complete discovery markets and $1,190.50 on 1,651 partial-OOS markets. The enhanced version reduces those results to -$137.89 and -$33.85; on partial OOS it also reduces maximum settlement drawdown from $1,300.52 to $91.45 and worst-window loss from $83.50 to $22.06. Profit factor remains 0.9686, so this is risk reduction rather than a demonstrated edge. Execution remains hard-locked to simulation. Full evidence is in `research/wallet-75cc/results/trend-noise-reversal-2026-09-02.md`.
