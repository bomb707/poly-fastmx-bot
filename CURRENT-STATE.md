...
- Runtime profile: detached `poly-fastmx-simulation` process is running
...
The session-aware release update raises full-cache participation from 47.28% to 48.96% (57 additional traded markets) and modeled P&L from +$94.65 to +$112.71 over 3,399 settled cached markets. Profit factor improves from 1.0461 to 1.0532 and maximum drawdown falls from $153.17 to $143.48. A global 0.875 cutoff was rejected despite 65.28% participation because it lost $301.05 with $395.36 drawdown. Details are in `research/wallet-75cc/results/session-release-threshold-2026-09-03.md`.
