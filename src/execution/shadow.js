...
export function createShadow(onEvent = () => {}, uiActive = () => true) {
  ...
  function cfgStamp() {
    ...
    return {
      ...
      trendNoisePullbackMinProbability: P.T_REGIME_PULLBACK_MIN_PROBABILITY,
      trendNoiseSizeFloor: P.T_REGIME_SIZE_FLOOR,
      trendNoiseSizeCeiling: P.T_REGIME_SIZE_CEILING,
